...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); //wait for pill images to load before intializing AOS

var pageHeader = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#PageHeader');

if (pageHeader.length !== 0 && (pageHeader.hasClass('.pill-header-4') || pageHeader.hasClass('.pill-header-7'))) {
  var pillImages = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.pill-holder img');
  Foundation.onImagesLoaded(pillImages, _lib_dependencies__WEBPACK_IMPORTED_MODULE_3__["default"].AOS.init());
} else {
  _lib_dependencies__WEBPACK_IMPORTED_MODULE_3__["default"].AOS.init();
} // SVG Injector
// Elements to inject
...
var injector = new _lib_dependencies__WEBPACK_IMPORTED_MODULE_3__["default"].svgInjector(injectorOptions); // Trigger the injection
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_dropdownMenu__WEBPACK_IMPORTED_MODULE_17__["DropdownMenu"], 'DropdownMenu'); //Foundation.plugin(Equalizer, 'Equalizer');
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_responsiveToggle__WEBPACK_IMPORTED_MODULE_24__["ResponsiveToggle"], 'ResponsiveToggle'); //Foundation.plugin(Reveal, 'Reveal');
//Foundation.plugin(Slider, 'Slider');

foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_smoothScroll__WEBPACK_IMPORTED_MODULE_27__["SmoothScroll"], 'SmoothScroll'); //Foundation.plugin(Sticky, 'Sticky');
//Foundation.plugin(Tabs, 'Tabs');

foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_toggler__WEBPACK_IMPORTED_MODULE_30__["Toggler"], 'Toggler'); //Foundation.plugin(Tooltip, 'Tooltip');
...
module.exports = __webpack_require__(/*! /Users/richardrudy/Documents/Projects/Sites/gtm-new/themes/GTM/src/assets/js/app.js */"./src/assets/js/app.js");
